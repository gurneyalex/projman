...
__revision__ = "$Id: unittest_lib_Task.py,v 1.8 2005-09-06 18:27:45 nico Exp $"
...
class ConsistencyTC(unittest.TestCase):
...
class DateConstraintsTC(unittest.TestCase):
...
class ProgressTC(unittest.TestCase):
